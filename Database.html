...
<div id="contact">
		...
		<form method="post" action="" id="contact-form">
			...
			<label for="message">and your message<sup>*</sup></label>
			...
			<label for="date"> Date from:<sup>*</sup> </label>
			<input type="date"><br>
			<label for="date"> To:<sup>*</sup> </label>
			<input type="date">
		<label for="select"> Choose water body<sup>*</sup></label>
	
		<select class="select">
		<option></option>
		<option>Plateliai, Ilgis</option>
		<option>Kauno marios</option>
		<option>Dusia, Metelys, Obelija</option>
		<option>Kuršių marios</option>
